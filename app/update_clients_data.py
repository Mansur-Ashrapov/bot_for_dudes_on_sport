...
@inject
async def update_clients_data(proxys_db, tg_clients_rep: TelegramClientRepository = Provide[AppContainer.tg_clients_rep], proxys_rep: ProxysRepositrory = Provide[AppContainer.proxys_repo]): 
